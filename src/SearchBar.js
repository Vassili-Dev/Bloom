  ...
  render() {
    return (
    	<div className={`search-container ${this.props.focused ? "showing" : ""}`}>
	      <input autoComplete="false" aria-label="Stock Search" className={`mainSearch ${(this.props.focused && this.props.text.length > 0)? 'focused' : ''}`} type="text" name="stockSearch" onBlur={this.props.onChangeFocus} onFocus={this.props.onChangeFocus} value={this.props.text} placeholder="Enter Ticker Here" onKeyDown={this.props.onKeyDown} onChange={this.props.onChangeSearch}></input>
